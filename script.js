...
const I18N = {
    ru: {
        ...
        contact_sub: 'Без формы сбора персональных данных — только прямые каналы связи. Телефон предоставляется по запросу.',
        ch_tg_lbl: 'Telegram',
        ...
        ch_hh_lbl: 'HH',
        ch_hh_value: 'Резюме на hh.ru',
        ch_hh_hint: 'Актуальный профиль для рекрутеров',
        resume_kicker: 'PDF',
        resume_name: 'Daniil Dunaev — Analyst / Architect',
        resume_sub: 'Актуальная версия резюме — PDF, одна страница, только подтверждённые данные.',
        wish_label: 'Ищу роль',
    ...
    en: {
        ...
        contact_sub: 'No data-collection form — only direct channels. Phone is available on request.',
        ch_tg_lbl: 'Telegram',
        ...
        ch_hh_lbl: 'HH',
        ch_hh_value: 'Resume on hh.ru',
        ch_hh_hint: 'Up-to-date profile for recruiters',
        resume_kicker: 'PDF',
        resume_name: 'Daniil Dunaev — Analyst / Architect',
        resume_sub: 'Latest resume — PDF, one page, verified data only.',
...
function bindEffects() {
    if (isTouch) return;
    document.querySelectorAll('.project-card, .exp-card, .artifact-card, .work-card, .channel-card').forEach(el => {
