...
const CONFIG = {
    ...
    skills: [
        ...
        {
            titleKey: 'sk7_title', items: ['sk7_l1', 'sk7_l2', 'sk7_l3', 'sk7_l4'],
            icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M16 11a4 4 0 1 0-4-4 4 4 0 0 0 4 4z"/><path d="M8 21v-1a5 5 0 0 1 8-4"/><path d="M12 13a5 5 0 0 1 5 5v1M6 15h6"/></svg>',
        },
        {
            titleKey: 'sk8_title', items: ['sk8_l1', 'sk8_l2', 'sk8_l3', 'sk8_l4'],
        ...
        {
            titleKey: 'sk9_title', items: ['sk9_l1', 'sk9_l2', 'sk9_l3', 'sk9_l4'],
            icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M3 6h18M7 12h10M5 18h14"/><path d="M12 3l-2 3h4l-2-3z"/></svg>',
        },
    ],
...
const I18N = {
    ru: {
        ...
        about_text: '<p>Понимание кода, баз данных и устройства стендов помогает мне видеть архитектурные ограничения еще на этапе обсуждения задачи.</p><p>Помимо проектирования решений (UML, BPMN, ArchiMate, C4) и ФТТ, я выстраиваю процессы аналитики: онбординг, стандарты документации, ревью — и помогаю коллегам расти.</p>',
        ...
        stg1_lbl: 'Аналитика',
        stg1_words: 'Требования · Use Cases · BPMN · Gap-анализ · AS-IS / TO-BE · Критерии приёмки',
        stg2_lbl: 'Интеграции',
        stg2_words: 'Kafka · CDC · ESB · REST / OpenAPI · Событийные архитектуры · SQL',
        stg3_lbl: 'Технологии',
        stg3_words: 'Docker · Kubernetes · LLM (Qwen) · RAG · Prometheus · Grafana',
        ...
        sk2_l3: 'ML-скоринг', sk2_l4: 'Интеграции с LLM, эмбеддинги',
        sk3_title: 'DevOps',
        ...
        sk5_title: 'Системный анализ',
        sk5_l1: 'Интеграции и шины данных: Kafka, CDC', sk5_l2: 'ESB, событийные архитектуры',
        sk5_l3: 'API-контракты: REST, OpenAPI', sk5_l4: 'Модели данных, SQL, схемы БД',
        sk6_title: 'Инструменты',
        sk6_l1: 'SQL, REST / OpenAPI, Postman, Kafka UI', sk6_l2: 'Jira, Confluence, Miro, draw.io',
        sk6_l3: 'Figma, Excel', sk6_l4: 'Git, Python для аналитики',
        sk7_title: 'Управление и процессы',
        sk7_l1: 'Наставничество и онбординг аналитиков', sk7_l2: 'Стандарты документации, ревью ФТТ',
        sk7_l3: 'Построение процессов и базы знаний', sk7_l4: 'Приоритизация, работа с рисками',
        sk8_title: 'Коммуникации',
        sk8_l1: 'Discovery-встречи, интервью со стейкхолдерами', sk8_l2: 'Фасилитация воркшопов и демо',
        sk8_l3: 'Презентации решений и защита гипотез', sk8_l4: 'Английский — техническая документация (B2+)',
        sk9_title: 'Бизнес-анализ',
        sk9_l1: 'Сбор требований: функциональные и нефункциональные', sk9_l2: 'Use Cases, User Stories, критерии приёмки',
        sk9_l3: 'BPMN, моделирование процессов', sk9_l4: 'Gap-анализ, AS-IS / TO-BE',
        ...
        exp1_a1: 'Совместно с РП выстроил процессы аналитики в новом подразделении: отвечаю за стандарты качества документации — база знаний в Confluence, глоссарий, структура и шаблоны ФТТ',
        exp1_a2: 'Организовал онбординг и выступаю наставником для двух системных аналитиков: распределяю задачи, провожу ревью документации и помогаю расти до самостоятельных исполнителей',
    ...
    en: {
        ...
        about_text: '<p>Understanding codebases, databases, and environments helps me spot architectural constraints right at the discussion phase.</p><p>Beyond designing solutions (UML, BPMN, ArchiMate, C4) and specs, I build analytics processes: onboarding, documentation standards, reviews — and help teammates grow.</p>',
        ...
        approach_kicker: 'Full-cycle analysis',
        approach_text: 'My strength is the <strong>full cycle</strong>: from a business problem to a working solution. I combine business analysis, systems design and delivery oversight — so I do not just write a spec, I deliver a working product with measurable impact. As a lead analyst I build team processes: documentation standards, onboarding, reviews and mentoring.',
        ...
        stg1_lbl: 'Analysis',
        stg1_words: 'Requirements · Use Cases · BPMN · Gap analysis · AS-IS / TO-BE · Acceptance criteria',
        stg2_lbl: 'Integration',
        stg2_words: 'Kafka · CDC · ESB · REST / OpenAPI · Event-driven architecture · SQL',
        stg3_lbl: 'Technology',
        stg3_words: 'Docker · Kubernetes · LLMs (Qwen) · RAG · Prometheus · Grafana',
        ...
        sk2_l3: 'ML scoring', sk2_l4: 'LLM integrations, embeddings',
        sk3_title: 'DevOps',
        sk3_l1: 'Docker, Kubernetes, Helm', sk3_l2: 'GitHub Actions',
        sk3_l3: 'Prometheus, Grafana', sk3_l4: 'OpenSearch',
        sk4_title: 'Product',
        ...
        sk5_l1: 'Integration & data buses: Kafka, CDC', sk5_l2: 'ESB, event-driven architecture',
        sk5_l3: 'API contracts: REST, OpenAPI', sk5_l4: 'Data models, SQL, DB schemas',
        sk6_title: 'Tools',
        sk6_l1: 'SQL, REST / OpenAPI, Postman, Kafka UI', sk6_l2: 'Jira, Confluence, Miro, draw.io',
        sk6_l3: 'Figma, Excel', sk6_l4: 'Git, Python for data analysis',
        sk7_title: 'Management & processes',
        sk7_l1: 'Mentoring and onboarding analysts', sk7_l2: 'Documentation standards, spec reviews',
        sk7_l3: 'Building processes and knowledge bases', sk7_l4: 'Prioritization, risk management',
        sk8_title: 'Communication',
        sk8_l1: 'Discovery meetings, stakeholder interviews', sk8_l2: 'Facilitating workshops and demos',
        sk8_l3: 'Solution presentations, hypothesis defense', sk8_l4: 'English — technical documentation (B2+)',
        sk9_title: 'Business analysis',
        sk9_l1: 'Requirements: functional & non-functional', sk9_l2: 'Use cases, user stories, acceptance criteria',
        sk9_l3: 'BPMN, process modeling', sk9_l4: 'Gap analysis, AS-IS / TO-BE',
        ...
        exp1_a1: 'Collaborated with the PM to build analytics processes in a new unit: I own documentation quality standards — Confluence knowledge base, glossary, structure, and spec templates',
        exp1_a2: 'Onboarded and mentor two systems analysts: assign tasks, review documentation, and help them grow into independent contributors',
